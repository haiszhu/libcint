...
nenv = numel(env);
mex_id_ = 'GTOval_uracil_dimer_aug_ccpvdz_mwrap(c i int[x], c i int[x], c i int[x], c io double[x], c i double[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[x])';
